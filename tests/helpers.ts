...
export function makeDb(): {
	...
	db.run(
       ...
       id INTEGER PRIMARY KEY AUTOINCREMENT,
       subject_id INTEGER NOT NULL, kind TEXT NOT NULL, path TEXT NOT NULL,
       status TEXT NOT NULL DEFAULT 'pending', score INTEGER,
       created_at TEXT DEFAULT CURRENT_DATE, completed_at TEXT,
       FOREIGN KEY (subject_id) REFERENCES subjects(id)
     );`,
	);
